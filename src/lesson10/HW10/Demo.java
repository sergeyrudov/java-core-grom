...
public class Demo {
    public static void main(String[] args) {
        ...
        ElectronicOrder e1 = new ElectronicOrder("Холодильник", new Date(), "Киев", "Одесса", 4876, customer, 12);
        ElectronicOrder e2 = new ElectronicOrder("Чайник", new Date(), "Киев", "Львов", 800, customer, 3);
